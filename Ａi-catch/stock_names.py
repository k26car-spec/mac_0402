...
STOCK_NAMES = {
    ...
    # 上櫃股票 (TPEx)
    '8046.TW': '南電',     # TWSE
    # '8046.TWO': '南電',  # Remove incorrect mapping
    '8155.TWO': '博智',    # TPEx
    '8021.TW': '尖點',     # TWSE
    # '8021.TWO': '尖點',  # Remove incorrect mapping
    '8110.TW': '華東',     # TWSE
    # '8110.TWO': '華東',  # Remove incorrect mapping
    '3706.TW': '神達',     # TWSE
    '3363.TWO': '上詮',    # TPEx (was 3363.TW)
    '5475.TWO': '德宏',    # TPEx
    '6257.TW': '矽格',     # TWSE
    '6257': '矽格',
    
    # Missing from previous list but present in logs/watchlist
    '1605.TW': '華新',
    '6282.TW': '康舒',
    '8074.TWO': '鉅橡',
    '1815.TW': '富喬',
    ...
    '6239.TW': '力成',
    '3653.TW': '健策',
    '6452.TW': '康友-KY', # Note: Suspended/Delisted? Keep for now if in list.
