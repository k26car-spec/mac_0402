...
export default function SniperPage() {
    ...
    const getApiUrl = (path: string) => {
        // Always force 127.0.0.1 for local dev to avoid IPv6 issues
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (data.watchlist && Array.isArray(data.watchlist)) {
                    ...
                    // Immediately trigger signal load
                    loadSignals(sectors);
                    return sectors;
                }
            }
            ...
            // Don't set isConnected false immediately to prevent UI flicker
            return null;
        }
    }, [activeSector]); // Removed loadSignals from dependency to avoid loop if used inside
    ...
    }, [loadConfig, fetchConnStatus]); // Removed loadSignals from dependency to break cycle
